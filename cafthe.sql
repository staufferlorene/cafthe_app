...
--
-- Hôte : localhost:3306
-- Généré le : lun. 31 mars 2025 à 08:02
...
(3, '2025-01-22', 'livrée', '789 Boulevard de Marseille, 13001 Marseille', 20.00, 4.00, 24.00, 1, 2),
(4, '2025-02-10', 'en préparation', '321 Rue de Lille, 59000 Lille', 30.00, 6.00, 36.00, 1, 2),
...
(11, '2025-04-05', 'expédiée', '123 Rue de Rennes, 35000 Rennes', 70.00, 14.00, 84.00, 2, 10),
(12, '2025-04-10', 'livrée', '456 Avenue de Reims, 51100 Reims', 80.00, 16.00, 96.00, 1, 10),
(13, '2025-04-15', 'en préparation', '789 Boulevard de Dijon, 21000 Dijon', 90.00, 18.00, 108.00, 2, 12),
(14, '2025-05-01', 'expédiée', '321 Rue de Brest, 29200 Brest', 100.00, 20.00, 120.00, 1, 14),
(15, '2025-05-05', 'livrée', '654 Rue de Limoges, 87000 Limoges', 110.00, 22.00, 132.00, 2, 15),
(16, '2025-05-10', 'en préparation', '123 Rue de Clermont, 63000 Clermont-Ferrand', 120.00, 24.00, 144.00, 1, 16),
(17, '2025-05-15', 'expédiée', '456 Avenue de Tours, 37000 Tours', 130.00, 26.00, 156.00, 2, 17),
(18, '2025-06-01', 'livrée', '789 Boulevard de Metz, 57000 Metz', 140.00, 28.00, 168.00, 1, 10),
(19, '2025-06-05', 'en préparation', '321 Rue de Perpignan, 66000 Perpignan', 150.00, 30.00, 180.00, 2, 10),
(20, '2025-06-10', 'expédiée', '654 Rue de Pau, 64000 Pau', 160.00, 32.00, 192.00, 1, 12);
...
--
ALTER TABLE `commande`
  MODIFY `Id_commande` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT pour la table `ligne_commande`
--
ALTER TABLE `ligne_commande`
  MODIFY `Id_ligne_commande` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
