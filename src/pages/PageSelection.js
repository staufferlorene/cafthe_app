...
function PageSelection({search}) {
    ...
    useEffect(() => {
        const fetchProduits = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/selection`);
    ...
    // SearchBar
    const filtrerProduits = item.filter((produit) => {
    ...
    return (
        <div className="page-container">
            <h1>Liste de notre sélection</h1>
            <div className="product-list">
